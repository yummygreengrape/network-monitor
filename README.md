...
탐지 임계값의 상당수는 **아직 근거가 얇습니다.** ARP 응답 급증의 "초당 10건",
왕복 시간 급변의 "연속 3주기", 조사 냉각의 "30주기" 같은 값은 실제 공격이나
장애를 충분히 겪어 보고 정한 것이 아닙니다. 실제로 상시 실행 기록을 읽다가
왕복 시간 판정이 너무 민감하다는 것을 발견해 고쳤고(한 시간에 아홉 번 떴습니다),
누적 카운터를 시간으로 나누지 않아 난 거짓 경보도 그렇게 찾았습니다.
