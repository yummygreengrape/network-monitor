...
# macOS arp 는 각 옥텟의 앞 0 을 떼고 출력한다(0:0:5e:0:53:1). 두 자리 고정
# 패턴만 보면 그런 값이 그대로 새어 나간다. 1~2 자리를 모두 받는다.
...
report IPV6 "문서용(2001:db8::/32) 밖 IPv6로 보이는 값" \
  ...
  ':(2001:[dD][bB]8|::1)|0?0:0?0:5[eE]:0?0:53|:[0-9a-fA-F]{1,2}(:[0-9a-fA-F]{1,2}){5}$|:[0-9]{1,2}(:[0-9]{2}){1,2}$'
