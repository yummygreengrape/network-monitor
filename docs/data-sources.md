...
- **한 주기 늦게 시작됩니다**: 주소가 직전 주기의 관측에서 오므로 끊긴 **첫 주기에는
  ...
  그 직전 주기의 사유에 주소가 있었는지에 달렸습니다(아래 "무엇을 재는가" 의 표본 참조).
...
(2026-09-16~22, **2026-09-22 19시 시점** 관측 86,225주기 — 수집이 계속 돌므로 나중에
...
이었고, **`connecting` 밖에서는 한 건도 나오지 않았습니다.** 여기서 "비연결" 은 보내는
