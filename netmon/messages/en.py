...
WZ_EXTERNAL_BODY = ("  and watches TLS issuers for fixed hosts plus public IP changes.\n"
                    "  While a VPN is down it also probes the tunnel endpoint address the\n"
                    "  provider reported (nothing is sent on normal cycles).\n"
...
WZ_ROW_EXTERNAL = "outbound checks %s  (DNS/TLS hijack, public IP, tunnel endpoint)"
